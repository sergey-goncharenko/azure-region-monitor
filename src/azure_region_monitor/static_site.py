      ...
      <div class="prose-body">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr><td>VM SKUs</td><td><code>az vm list-skus --location &lt;region&gt; --resource-type virtualMachines --all</code> listed the SKU, or the legacy <code>az vm list-sizes --location &lt;region&gt;</code> fallback listed it.</td><td>The supported SKU listing succeeded, the fallback did not add the SKU, and the SKU was absent from that regional list.</td></tr>
          </tbody>
        </table>
      </div>
    </section>
