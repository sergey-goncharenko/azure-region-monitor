...
- `.github/workflows/scheduled-azure-maintenance.yml` runs as the separate public documentation alignment session. It may edit only `README.md`, `.github/copilot-instructions.md`, and `docs/agentic-sessions.md`.
