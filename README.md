...
- A GitHub Actions workflow for manual or scheduled PoC runs, plus a separate scheduled public Azure documentation alignment session (`.github/workflows/scheduled-azure-maintenance.yml`) that may edit only `README.md`, `.github/copilot-instructions.md`, and `docs/agentic-sessions.md`
