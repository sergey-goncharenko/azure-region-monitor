...
## Deliverables
- Synthetic test runner for current modalities: AKS extension catalog, AKS Kubernetes versions, Azure Functions Flex, Azure AI model catalog, Container Apps provider metadata, and VM SKUs
